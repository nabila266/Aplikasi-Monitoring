                        ...
                        <div class="px-4 sm:px-6 lg:px-8">
                            <div class="sm:flex sm:items-center">
                              ...
                              <a href="/agen/produk/tambah/" type="button" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Tambah Produk</a>
                                ...
                                <form action="{{ route('produk.exportPDF') }}" method="GET" class="flex flex-col mt-4 sm:flex-row sm:items-end sm:space-x-4 space-y-4 sm:space-y-0">
                          ...
                          <span class="line-clamp-2">
                            {{ $produk->deskripsi_produk }}
                                            ...
                                            <td class="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">
                                                <img src="{{ asset('storage/'.$produk->foto_produk) }}" alt="" class="w-12 h-16 object-cover rounded-md">
                                            </td>
                          ...
                          <span class="isolate inline-flex rounded-md shadow-sm">
                            <a href="/agen/produk/edit/{{ Str::slug($produk->nama_produk) }}" type="button" class="relative rounded-l-md -ml-px inline-flex items-center bg-indigo-600 px-3 py-2 text-sm font-semibold text-white ring-1 ring-inset ring-white hover:bg-indigo-500 focus:z-10">Ubah</a>
                            <form action="{{ route('agen.produk.delete', $produk->id) }}" method="POST">
                              @csrf
                                @method('DELETE')
                              <button type="submit" class="relative -ml-px inline-flex items-center rounded-r-md bg-red-600 px-3 py-2 text-sm font-semibold text-white ring-1 ring-inset ring-white hover:bg-red-500 focus:z-10">Hapus</button>
                            </form>
                          </span>
                                            </td>
                                        </tr>
