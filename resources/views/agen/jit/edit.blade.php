          ...
          <div class="bg-white py-10">
            <div class="mx-auto max-w-7xl">
              ...
              <div class="relative flex justify-center overflow-hidden rounded-xl">
                <form class="w-screen max-w-screen-md bg-white shadow-sm p-8 rounded-xl" action="{{ route('agen.jit.update', $jit->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="space-y-12">
                      ...
                      <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-full grid md:grid-cols-2 grid-cols-1 gap-4">
                          <div>
                            ...
                            <div class="mt-2">
                              <input id="kuantitas_pemesanan" name="kuantitas_pemesanan" value="{{ $jit->kuantitas_pemesanan }}" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4" placeholder="0">
                          ...
                          <div>
                            ...
                            <div class="mt-2">
                              <input id="rata_rata_target_persediaan" name="rata_rata_target_persediaan" value="{{ $jit->rata_rata_target_persediaan }}" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4" placeholder="0">
                          ...
                          <div>
                            ...
                            <div class="mt-2">
                              <input id="biaya_pemesanan_per_unit" name="biaya_pemesanan_per_unit" value="{{ $jit->biaya_pemesanan_per_unit }}" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4" placeholder="0">
                          ...
                          <div>
                            ...
                            <div class="mt-2">
                              <input id="jumlah_kebutuhan_bahan_baku_tahunan" name="jumlah_kebutuhan_bahan_baku_tahunan" value="{{ $jit->jumlah_kebutuhan_bahan_baku_tahunan }}" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4" placeholder="0">
                    ...
                    <div class="flex items-center justify-end mt-6 gap-x-6">
                      ...
                      <button type="submit" class="px-3 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Ubah</button>
                    </div>
                  </div>
                </form>
              </div>
